...
static $dbhost="localhost";		//Database address
static $dbuser="root";				//Database username
static $dbpass="";			//Database password
static $dbname="2014_project_codeme";			//Database name
